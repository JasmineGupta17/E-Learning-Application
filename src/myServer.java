    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files) 
    {
       ...
       File folder = new File("src/uploads/");
        ...
        for (int i = 0; i < listOfFiles.length; i++) {
            ...
            if (listOfFiles[i].isFile()) {
                ...
                File f = new File("src/uploads/"+listOfFiles[i].getName()); 
                 if(st.charAt(0) == '\\')
                         {
       ...
       File folder = new File("src/uploads/");
        ...
        for (int i = 0; i < listOfFiles.length; i++) {
            ...
            File folder1 = new File("src/Lectures/");
        ...
        for (int i = 0; i < listOfFiles1.length; i++) {
            ...
            if (listOfFiles1[i].isFile()) {
                ...
                String name2 =listOfFiles1[i].getName();
                
                StringBuilder st = new StringBuilder(name2);

                File f = new File("src/Lectures/"+listOfFiles1[i].getName()); 
                 if(st.charAt(0) == '\\')
                         {
                 f.renameTo(new File("src/Lectures/"+st.deleteCharAt(0)));
                        }
            }
        } 
