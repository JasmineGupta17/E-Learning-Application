...
public class Manage_Lectures extends javax.swing.JFrame {
 ...
 class myTableModel extends AbstractTableModel
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(0, 0, 800, 32);

        jLabel2.setText("View Lectures");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(520, 40, 220, 16);

        jLabel3.setText("Add Lectures");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(20, 40, 220, 16);

        jLabel4.setText("Description");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(20, 180, 200, 16);
        getContentPane().add(descriptiontf);
        descriptiontf.setBounds(20, 210, 300, 22);

        jLabel5.setText("name");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(20, 110, 200, 16);
        getContentPane().add(Nametf);
        Nametf.setBounds(20, 140, 300, 22);
        getContentPane().add(durationtf);
        durationtf.setBounds(20, 280, 300, 22);

        jLabel6.setText("Duration");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(20, 250, 200, 16);

        jLabel7.setText("Duration");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(20, 250, 200, 16);

        jLabel8.setText("Lecture");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(20, 390, 200, 16);
        getContentPane().add(trailertf);
        trailertf.setBounds(20, 350, 300, 22);

        jLabel9.setText("Traier");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(20, 320, 200, 16);
        ...
        jLabel10.setBounds(20, 460, 120, 16);
